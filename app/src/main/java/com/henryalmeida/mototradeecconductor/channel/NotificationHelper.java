package com.henryalmeida.mototradeecconductor.channel;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.henryalmeida.mototradeecconductor";
    private static final String CHANNEL_NAME = "Mototradeecconductor";
    ...
    // Las notificaciones pueden tener un maximo de 3 acciones
    @RequiresApi(api = Build.VERSION_CODES.O)
